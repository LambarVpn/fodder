...
echo -e "\e[33;1m│\e[0m \033[44;1;97;1m                  LAMBAR TUNNEL                   \033[0m \e[33;1m│\e[0m"
echo -e "\033[33;1m└─────────────────────────────────────────────────┘\033[0m "
sleep 4
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/LambarVpn/permission/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/LambarVpn/permission/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/LambarVpn/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
# LINK REPOSITORY
REPO="https://raw.githubusercontent.com/LambarVpn/Source/main/"
CONFIG="https://raw.githubusercontent.com/LambarVpn/fodder/main/"
########################################################
...
# LINK REPOSITORY
MENUREPO="https://raw.githubusercontent.com/LambarVpn/Source/main/"
...
#wget -q -O slowdns.sh https://raw.githubusercontent.com/LambarVpn/Source/main/Dns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
}
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/LambarVpn/permission/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/LambarVpn/permission/main/ip | grep $ipsaya | awk '{print $3}')
TIMES="10"
CHATID="59708071"
...
cd /bin
git clone  https://github.com/LambarVpn/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
